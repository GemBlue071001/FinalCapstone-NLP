...
CREATE TABLE public."JobPostActivities" (
  "Id" SERIAL NOT NULL,
...
ALTER TABLE public."JobPostActivities" ADD CONSTRAINT "PK_JobPostActivities" PRIMARY KEY ("Id");
...
ALTER TABLE "JobPostActivities"
  ADD CONSTRAINT "fk_JobPostActivities_User" FOREIGN KEY ("UserId") REFERENCES "Users" ("Id");
ALTER TABLE "JobPostActivities" 
  ADD CONSTRAINT "fk_JobPostActivities_JobPost" FOREIGN KEY ("JobPostId") REFERENCES "JobPosts" ("Id");
ALTER TABLE "JobPostActivities" 
  ADD CONSTRAINT "fk_JobPostActivities_CV" FOREIGN KEY ("CvId") REFERENCES "CVs" ("Id");
